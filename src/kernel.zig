...
// @TODO: Take in new boot images from the serial port for easier real hardware testing.

// @TODO: Parse input from UART0 and handle commands. Should just be able to
...
export fn kmain() noreturn {
    ...
    // Enter low power state and hang if we get someone get out of the while loop.
    util.powerOff();
    util.hang();
}
